...
acf_add_local_field_group(array(
	...
	'fields' => array(
		array(
			'key' => 'field_5a4e7db764361inheader',
			'label' => __( 'Header scripts', 'braftonium' ),
			'name' => 'header_script',
			'type' => 'textarea',
			'instructions' => 'add scripts in the head (tracking scripts, et)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5a4e7db764361afterbody',
			'label' => __( 'After Body scripts', 'braftonium' ),
			'name' => 'body_script',
			'type' => 'textarea',
			'instructions' => 'Some tracking scripts ask for parts to be added just after the opening body tag. You may place those here.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5a4e7db764361infooter',
			'label' => __( 'Footer scripts', 'braftonium' ),
			'name' => 'footer_script',
			'type' => 'textarea',
			'instructions' => 'add scripts in the footer (tracking scripts, et)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
